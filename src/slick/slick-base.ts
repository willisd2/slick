...
{ 
    ...
    public autoPlayTimer: number = null;
    ...
    public animateSlide(targetLeft, callback) {
    ...
    public changeSlide(event, dontAnimate) {
    ...
    public disableTransition(slide) {
    ...
    public fadeSlide(slideIndex, callback) {
    ...
    public fadeSlideOut(slideIndex) {
    ...
    public progressiveLazyLoad( tryCount ) {
    ...
    public slideHandler(index, sync, dontAnimate) {
